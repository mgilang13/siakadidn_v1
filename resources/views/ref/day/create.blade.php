...
<div class="content">
    ...
    <form action="{{ route('ref.day.store') }}" method="POST">
        @csrf
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <div class="d-flex flex-column">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" id="name" type="text" name="name" placeholder="Hari" value="{{ old('name') }}" autofocus>
                                @error('name')
