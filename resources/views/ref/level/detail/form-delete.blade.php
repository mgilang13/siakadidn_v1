<form id="form-delete-detail" action="" class="row" method="{{ $method }}">
@method( $methodx )
@csrf
<div class="modal fade" id="deleteModalDetail" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            Are you sure to delete the <span id="meta-to-delete-detail"></span> {{$title_menu}}?
        </div>
...
<script>
    $(document).on('click', '#deleteDataDetail', function() {
        let id = $(this).data('id');
        ...
        axios.get(showDataUrl).then(dataMeta => {
            ...
            $('#meta-to-delete-detail').text(data.name);
            $('#form-delete-detail').attr('action', urlDelete);
        });
    });
</script>
</form>
