...
@section('content')
<div class="content">
    <form action="{{ route('ref.parent.store') }}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-8">
                <div class="card">
                    ...
                    <div class="form-group row">
                        <div class="col input-with-icon d-flex">
                            <i width="18" data-feather="edit-3" class="align-self-center ml-3"></i>
                            <input class="form-control @error('name') is-invalid @enderror" id="name" type="text" name="name" placeholder="Nama Pengguna" value="{{ old('name') }}" autofocus>
                            @error('name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
