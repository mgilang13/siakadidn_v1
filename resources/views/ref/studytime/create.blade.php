...
<div class="content">
    ...
    <form action="{{ route('ref.studytime.store') }}" method="POST">
        @csrf
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <div class="d-flex flex-column">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" id="name" type="text" name="name" placeholder="Jam Ke" value="{{ old('name') }}" autofocus>
                                @error('name')
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <div class="d-flex flex-column">
                                ...
                                <input id="end_time" type="time" class="form-control" name="end_time" value="{{ old('end_time') }}">
                            </div>
                        </div>
                    </div>
